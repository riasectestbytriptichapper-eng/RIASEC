...
# ---------------- SESSION STATE ----------------
for key in ["show_test", "submitted", "email_sent", "responses", "info", "scores"]:
    if key not in st.session_state:
        st.session_state[key] = {} if key in ["responses", "info", "scores"] else False

st.session_state.scores = {"R":0,"I":0,"A":0,"S":0,"E":0,"C":0} if not st.session_state.scores else st.session_state.scores
...
# ---------------- SUBMIT BUTTON ----------------
all_answered = len(st.session_state.responses) == len(questions) and all(v > 0 for v in st.session_state.responses.values())
